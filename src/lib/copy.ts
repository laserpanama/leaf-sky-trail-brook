...
export const copy = {
  es: {
    ...
    cart: "Pedido",
    cartTitle: "El pedido",
    cartEmpty: "Todavía no hay nada. Pide desde la carta o la barra.",
    cartAdd: "Pedir",
    cartMesa: "En el local",
    cartGo: "Para llevar",
    cartNote: "Nota",
    cartNotePh: "Sin cebolla, mesa alta…",
    cartSend: "Enviar pedido por WhatsApp",
    cartTax: "ITBMS incluido",
    cartTotal: "Total",
    cartSent: "WhatsApp abierto.",
    cartSentBody:
      "El mensaje lleva el pedido y la nota. El nombre no se guarda. La casa confirma por ahí. Se paga en el local: Visa, Mastercard, efectivo o Yappy.",
    cartGone: "Ya no está.",
    cartLead: "Precios de la carta, con ITBMS. No es delivery.",
    payHow: "Cómo pagas",
    payYappy: "Yappy",
    payCard: "Tarjeta",
    payCash: "Efectivo",
    ...
    yappyPhoneHint: "Solo para que te pidan el Yappy. No se guarda.",
    yappyPhoneBad: "El celular va con 8 dígitos, o 11 si empieza con 507.",
  ...
  en: {
    ...
    cart: "Order",
    cartTitle: "The order",
    cartEmpty: "Nothing yet. Add from the menu or the bar.",
    cartAdd: "Add",
    cartMesa: "Here",
    cartGo: "To go",
    cartNote: "Note",
    cartNotePh: "No onion, high table…",
    cartSend: "Send order on WhatsApp",
    cartTax: "ITBMS included",
    cartTotal: "Total",
    cartSent: "WhatsApp is open.",
    cartSentBody:
      "The message has the order and the note. A name is not stored. The house confirms there. You pay at the bar: Visa, Mastercard, cash, or Yappy.",
    cartGone: "No longer on the menu.",
    cartLead: "Menu prices, ITBMS included. This is not delivery.",
    payHow: "How you pay",
    payYappy: "Yappy",
    payCard: "Card",
    payCash: "Cash",
    ...
    yappyPhonePh: "6000-0000",
    yappyPhoneHint: "Only so they can request the Yappy. It is not stored.",
    yappyPhoneBad: "Use 8 digits, or 11 if it starts with 507.",
